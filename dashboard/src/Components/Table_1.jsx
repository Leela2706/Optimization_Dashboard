...
//       {/* Heading */}
//       <h1 className="text-2xl font-semibold mb-6 text-left">Frequency Change (96)</h1>
...
//             <th className="p-3 font-medium text-gray-300">Outwith Defaults</th>
//             <th className="p-3 font-medium text-gray-300">Manufacturer</th>
//             <th className="p-3 font-medium text-gray-300">Contact</th>
//             <th className="p-3 font-medium text-gray-300">Freq (Hz)</th>
//             <th className="p-3 font-medium text-gray-300">New Freq (Hz)</th>
//             <th className="p-3 font-medium text-gray-300">FC Add, Oil (stb/d)</th>
//             <th className="p-3 font-medium text-gray-300">Inc. Change (Hz)</th>
//             <th className="p-3 font-medium text-gray-300">Run Life Days</th>
//             <th className="p-3 font-medium text-gray-300">PID Control Mode</th>
